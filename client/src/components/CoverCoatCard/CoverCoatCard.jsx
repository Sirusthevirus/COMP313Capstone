...
import styles from "./CoverCoatCard.module.css"
import AddIcon from '@mui/icons-material/Add';
import DeleteIcon from '@mui/icons-material/Delete';

const CoverCoatCard = ({ options, ids, setIds, numberOfUse, setNumberOfUse }) => {
    // States
    ...
    return (
        <Paper sx={{ borderRadius: "20px", display: "flex", flexDirection: "column", alignItems: "flex-start", gap: "24px", padding: "24px", marginTop: "24px" }}>
            {/* Title */}
            <Typography variant="h4">Cover Coat</Typography>
