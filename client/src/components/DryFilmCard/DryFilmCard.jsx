...
import styles from "./DryFilmCard.module.css";
import AddIcon from "@mui/icons-material/Add";
import DeleteIcon from "@mui/icons-material/Delete";

const DryFilmCard = ({ options, ids, setIds, numberOfUse, setNumberOfUse }) => {
  // States
  ...
  return (
    ...
    >
      {/* Title */}
      <Typography variant="h4">Dry Film & Wet Processes</Typography>
